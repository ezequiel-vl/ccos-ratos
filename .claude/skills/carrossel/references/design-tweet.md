...
- **Foto de perfil:** círculo de 80-90px. Se tiver foto, usar `<img>` com `border-radius: 50%`. Se não tiver, criar círculo com as iniciais (fundo na cor de destaque do cliente, texto branco, font-size 32px)
- **Nome:** ao lado da foto, font-size 28-32px, font-weight 700, cor #0F1419
- **Badge verificado** (opcional): usar o SVG em `references/badge-verificado.svg` ao lado do nome. Tamanho 26-28px. Só incluir se ativado no briefing
...
Se quiser incluir uma imagem (print de tela, screenshot, etc), colocar embaixo do texto como se fosse imagem anexada a um tweet:

- Width: 100% (com padding lateral)
- Border-radius: 16px
- Border: 1px solid #EFF3F4
- object-fit: cover
- Sem card de link preview, sem caixinha com titulo/descrição. Só a imagem pura
...
- **Fonte recomendada:** `font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif`
- **Se o briefing do cliente tiver fontes definidas:** usar a fonte de corpo. O estilo tweet funciona com qualquer fonte limpa
- **Nunca usar:** fontes decorativas, serifadas pesadas, ou condensadas
...
- **Slide de texto puro:** header + texto. O mais comum
- **Slide com dado em destaque:** um número grande (64-80px, bold, cor de destaque) no meio do texto
- **Slide com lista:** itens com emoji de dedo apontando ou bullet points simples. Espaçamento generoso
- **Slide de capa:** texto maior (48-56px), menos texto, mais impacto
- **Slide de CTA:** @ do perfil maior, ou botão estilizado embaixo
...
- **Emoji permitido** no corpo do texto
- **Negrito pra destaque** é o único recurso visual no texto
...
- **Texto secundário (handle):** #536471
- **Links/destaques:** cor de destaque do briefing do cliente (ou #1D9BF0 azul Twitter como fallback)
