...
As imagens ficam na pasta `clientes/[cliente]/carrossel/[data]-[tema]/imagens/`.
...
- Cor em slides claros: cor de destaque do briefing do cliente
- Cor em slides escuros: branco

### Logo no slide final
Se o briefing do cliente tiver logo definido:
