...
Usar fontes do briefing do cliente, mas com intenção:
...
Imagens em `clientes/[cliente]/carrossel/[data]-[tema]/imagens/`, referência relativa no HTML.
...
Se o briefing do cliente tiver logo, incluir no CTA: 120-200px.
